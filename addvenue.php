...
<div id="main">
  <h1><u>Add a Venue</u></h1>
	...
	echo "<a href=\"uploadImage.php?sent=venimg&venue=$venueID&other=$photo\" target=\"_blank\"> Upload</a></label> ";
	//echo "<input type='button' onClick=\"parent.location = 'uploadImage.php?sent=venimg';\" ";
	//echo "value=' Upload ' /></label> ";
	echo "<input name='picture' type='text' value='$picture' />";
	echo "<br /><label for='picture'>Map Image: ";
	echo "<a href=\"uploadImage.php?sent=venmap&venue=$venueID&other=$photo\" target=\"_blank\"> Upload</a></label> ";
